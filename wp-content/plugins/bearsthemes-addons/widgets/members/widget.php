<?php
namespace BearsthemesAddons\Widgets\Members;
...
class Be_Members extends Widget_Base {
	...
	public function get_title() {
		return __( 'Be Members', 'bearsthemes-addons' );
	}
		...
		if( !empty( $cats ) ) {
			?>
				<div class="<?php echo esc_attr( $classes ); ?>">
					<ul class="elementor-filter" data-type="member">
						<?php
							echo '<li>
										<a class="elementor-filter__link active" href="#" data-filter="all">' . esc_html__( 'Our Team', 'bearsthemes-addons' ) . '</a>
									</li>';

							foreach ($cats as $key => $value) {
								$cat = get_term_by('id', $value, 'team_category');
